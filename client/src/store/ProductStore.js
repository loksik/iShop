...
export default class ProductStore {
    constructor() {
        ...
        this._products = []
        this._ratings = [
            {id:2,	rate:5,	review:'Когда я заказал у продавца товар связались быстро!',	createdAt:'2022-06-02 03:42:09.838 +0500',	updatedAt:'2022-06-02 03:42:09.838 +0500',	userId:1,	productId:1},
